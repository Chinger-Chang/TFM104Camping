#pragma checksum "C:\Users\user\Desktop\TFM104Camping\FinalProjectFirstTest\FinalProjectFirstTest\Views\Buyer\BOrderDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "82ff3bc62e99d5c6e70b081ceb835a56a4f00a96"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"82ff3bc62e99d5c6e70b081ceb835a56a4f00a96", @"/Views/Buyer/BOrderDetail.cshtml")]
	...
	<v-app>
		<ul class=""nav nav-tabs"" id=""myTab"" role=""tablist"">
			<li class=""nav-item myItem"" role=""presentation"">
				<a class=""n");
            WriteLiteral(@"av-link active"" id=""home-tab"" data-toggle=""tab"" href=""#home"" role=""tab"" aria-controls=""home"" aria-selected=""true"" style=""color:white;"">已預定</a>
			</li>
			<li class=""nav-item myItem"" role=""presentation"">
		...
		<div class=""tab-content"" id=""myTabContent"">
            ...
            WriteLiteral(@"									<th class=""text-left"" scope=""col"">訂單編號</th>
									...
									<th class=""text-left"" scope=""col"">取消?</th>
...
");
            ...
            WriteLiteral(">\r\n\t\t\t\t\t\t<template v-slot:default>\r\n\t\t\t\t\t\t\t<thead>\r\n\t\t\t\t\t\t\t\t<tr>\r\n");
            WriteLiteral("\t\t\t\t\t\t\t\t\t<th class=\"text-left\" scope=\"col\">訂單編號</th>\r\n\t\t\t\t\t\t\t\t\t<th class=\"text-left\" scope=\"col\">露營區</th>\r\n\t\t\t\t\t\t\t\t\t<th class=\"text-left\" scope=\"col\">房名</th>\r\n\t\t\t\t\t\t\t\t\t<th class=\"text-left\" scope=\"col\">房型</th>\r\n");
            WriteLiteral("\t\t\t\t\t\t\t\t\t<th class=\"text-left\" scope=\"col\">要訂房嗎?</th>\r\n\r\n\t\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</thead>\r\n\t\t\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t\t\t<tr v-for=\" (x,index) in FavoriteOrderDetailsList\">\r\n");
            WriteLiteral("\t\t\t\t\t\t\t\t\t<th>{{x.orderDetailId}}</th>\r\n\t\t\t\t\t\t\t\t\t<th>{{x.campingAreaName}}</th>\r\n\t\t\t\t\t\t\t\t\t<th>{{x.roomName}}</th>\r\n\t\t\t\t\t\t\t\t\t<td>{{x.roomType}}</td>\r\n");
            WriteLiteral(@"									<td>
										<v-btn v-on:click=""sendRoomId(x.roomId)"" color=""#586D80"" dark>
											<v-icon left>mdi-hand-pointing-up</v-icon>我要訂房!
										</v-btn>
