#pragma checksum "C:\Project TFM104\TFM104Camping\FinalProjectFirstTest\FinalProjectFirstTest\Views\Buyer\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "96b08fae0b121590e24cff705ab6f13500e4e8d8"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"96b08fae0b121590e24cff705ab6f13500e4e8d8", @"/Views/Buyer/Index.cshtml")]
    ...
    public class Views_Buyer_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<FinalProjectFirstTest.Models.Camping_Area>
    {
        ...
        {
            WriteLiteral("\r\n<!DOCTYPE html>\r\n<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96b08fae0b121590e24cff705ab6f13500e4e8d84337", async() => {
                WriteLiteral(@"
    <style>
        .a {
...
");
            ...
            WriteLiteral("\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96b08fae0b121590e24cff705ab6f13500e4e8d85877", async() => {
                WriteLiteral(@"
    <div id=""mika"">
        <v-app>
            <template>
...
");
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("select", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96b08fae0b121590e24cff705ab6f13500e4e8d87216", async() => {
                    WriteLiteral("\r\n                        ");
                    __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "96b08fae0b121590e24cff705ab6f13500e4e8d87508", async() => {
                        WriteLiteral("選擇地區");
                    }
                    );
...
#nullable restore
#line 73 "C:\Project TFM104\TFM104Camping\FinalProjectFirstTest\FinalProjectFirstTest\Views\Buyer\Index.cshtml"
...
#nullable disable
                ...
                <div class=""a"" style=""padding-top:100px"">
                    <v-btn v-if=""moreShowBoolen"" ");
                WriteLiteral(@"@click=""moreShow"" color=""#9575CD"" dark>
                        加載更多<v-icon>mdi-cursor-pointer</v-icon>
                    </v-btn>
                    <v-btn v-else color=""#FF7043"" dark>
                        已經全部了<v-icon>mdi-cursor-pointer</v-icon>
                    </v-btn>
                </div>
    ...
    <script>
        var v = new Vue({
            ...
            data: {
                ...
                aaa: [
                    {
                        src: '/Camping_Area_Picture/Rilakkuma.PNG',
                    },
                    {
                        src: '/Camping_Area_Picture/Rilakkuma.PNG',
                    },
                ...
                RR: [""基隆"", ""新北市"", ""台北市"", ""桃園"", ""新竹"", ""苗栗"", ""台中"", ""彰化"",
                    ""南投"", ""雲林"", ");
                WriteLiteral(@"""嘉義"", ""台南"", ""高雄"", ""屏東"", ""宜蘭"", ""花蓮"", ""台東""]
            },
            methods: {
                ...
                init() {
                    axios.get(""/Buyer/getIndexInfo"").then(res => {
                        if (res.data.length <= 8) { // 5個一頁
                            this.IndexInfo = res.data
                            this.moreShowBoolen = false
                        } else {
                            this.IndexInfo = res.data.slice(0, 8)
                ...
                moreShow() { // 點擊查詢更多
                    axios.get(""/Buyer/getIndexInfo"").then(res => {
                        this.IndexInfo = this.IndexInfo.concat(res.data.slic");
                WriteLiteral(@"e(this.nowPage * 8, (this.nowPage + 1) * 8))
                        this.nowPage++
                        if (res.data.length >= this.nowPage * 8) {
                            this.moreShowBoolen = true
                        } else {
                            this.moreShowBoolen = false
                        }
