#pragma checksum "C:\Users\user\Desktop\TFM104Camping\FinalProjectFirstTest\FinalProjectFirstTest\Views\Order_Detail\Seller_OrderDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4cd4ccf6a343c86828993ca8cc7298e0bb573449"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4cd4ccf6a343c86828993ca8cc7298e0bb573449", @"/Views/Order_Detail/Seller_OrderDetail.cshtml")]
...
<div class=""mt-5"" id=""mika"">
	...
	<div class=""tab-content"" id=""myTabContent"">
		...
		<div class=""tab-pane fade"" id=""profile"" role=""tabpanel");
            WriteLiteral(@""" aria-labelledby=""profile-tab"">
	...
	<div class=""modal fade"" id=""staticBackdrop"" data-backdrop=""static"" data-keyboard=""false"" tabindex=""-1"" aria-labelledby=""staticBackdropLabel"" ari");
    ...
    var a = new Vue({
		...
		computed: {
			searchOrderDetail() {
				...
				if (this.search !== '') {
					se = this.Ord");
            WriteLiteral(@"erDetailsList.filter(p =>
			...
			searchCancelOrderDetailsList() {
				...
				if (this.search !== '') {
					se = this.CancelOrderDetailsList.filter(p =>
						...
						p.roomType.toLowerCase().includes(this.search.toLowerCase()) ||
						p.name.");
            WriteLiteral(@"toLowerCase().includes(this.search.toLowerCase()) ||
						p.phone.toLowerCase().includes(this.search.toLowerCase()) ||
						p.checkInDate.toLowerCase().includes(this.search.toLowerCase()) ||
						p.checkOutDate.toLowerCase().includes(this.search.toLowerCase()) ||
						p.status.toLowerCase().includes(this.search.toLowerCase()) ||
